...
pattern B0' <- B Zero _ _ _ _ _
pattern B1' a <- B One a _ _ _ _
pattern B2' a b <- B Two a b _ _ _
pattern B3' a b c <- B Three a b c _ _
pattern B4' a b c d <- B Four a b c d _
pattern B5' a b c d e <- B Five a b c d e

pattern B0'' <- B Zero _ _ _ _ _
pattern B1'' <- B One _ _ _ _ _
pattern B2'' <- B Two _ _ _ _ _
pattern B3'' <- B Three _ _ _ _ _
pattern B4'' <- B Four _ _ _ _ _
pattern B5'' <- B Five _ _ _ _ _
